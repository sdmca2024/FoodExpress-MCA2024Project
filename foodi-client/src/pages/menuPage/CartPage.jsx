...

      {
        ...
        <div>
          <div className="overflow-x-auto">
            <table className="table">
              {/* head */}
              <thead className="bg-orange-600 text-white rounded-sm">
                <tr>
                  <th>#</th>
                  <th>Food</th>
                  <th>Item Name</th>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start my-12 gap-8">
          ...
          <div className="md:w-1/2 space-y-3">
            ...
            <Link to="/process-checkout" className="btn btn-md bg-orange-600 text-white px-8 py-1">
        ...
        <Link to="/menu"><button className="btn bg-orange-600 text-white mt-3">Back to Menu</button></Link>
      </div>
      }
