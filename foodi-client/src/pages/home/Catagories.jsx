...
const Catagories = () => {
  ...
  return (
    <div className={`max-w-screen-2xl container mx-auto xl:px-14 px-4 py-16 ${isDarkMode ? 'dark' : ''}`}>
        ...
        <div className='flex flex-col sm:flex-row flex-wrap gap-4 justify-around items-center mt-12 '>
            {
                categoryItems.map((item, i) => (
                    <div key={i} className='shadow-lg rounded-md bg-white py-6 px-5 w-72 mx-auto text-center cursor-pointer hover:-translate-y-4 transition-all duration-300 z-10'>
                        <div className='w-full mx-auto flex items-center justify-center'><img src={item.image} alt="" className='bg-orange-200 p-5 rounded-full w-28 h-28' /></div>
