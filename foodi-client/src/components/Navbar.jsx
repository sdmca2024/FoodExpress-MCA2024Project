        ...
        <div className="navbar-end ">
         ...
         <label
          ...
          { 
            user ? <>
           <Profile user={user}/>
          </> : <button onClick={()=>document.getElementById('my_modal_5').showModal()} className="btn flex items-center gap-2 rounded-full px-6 bg-orange-600 text-white">
            <FaRegUser /> Login
          </button>
          }
          <Modal/>
