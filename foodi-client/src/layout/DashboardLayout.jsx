    ...
    <div>
      {
        ...
        <div className="drawer-content flex flex-col sm:items-start sm:justify-start my-2">
          ...
          <div className="flex items-center justify-between mx-4">
            ...
            {/* login or signout */}
            <button className="btn flex items-center gap-2 rounded-full px-6 bg-orange-600 text-white sm:hidden">
              <FaRegUser /> Logout
            </button>
          </div>
        ...
        <div className="drawer-side">
          ...
          <ul className="menu py-20 px-4 w-80 min-h-full bg-base-200 text-base-content">
